...
func main() {
	...
	flag.BoolVar(&opts.DirectDelivery, "direct-delivery", false, "Enable direct image delivery to k3s/RKE2 image directory")
	flag.StringVar(&opts.ImageDir, "image-dir", "", "Directory path for direct image delivery")
